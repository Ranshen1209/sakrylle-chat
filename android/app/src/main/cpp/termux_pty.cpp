...
// JNI class: com.sakrylle.chat.workspace.PtyJni
...
Java_com_sakrylle_chat_workspace_PtyJni_createSubprocess(
        JNIEnv *env,
        jclass,
        jstring cmd,
        jstring cwd,
...
Java_com_sakrylle_chat_workspace_PtyJni_setPtyWindowSize(
...
extern "C" JNIEXPORT jint JNICALL
Java_com_sakrylle_chat_workspace_PtyJni_waitFor(JNIEnv *, jclass, jint pid) {
    int status = 0;
...
extern "C" JNIEXPORT void JNICALL
Java_com_sakrylle_chat_workspace_PtyJni_close(JNIEnv *, jclass, jint fd) {
    close(fd);
}
