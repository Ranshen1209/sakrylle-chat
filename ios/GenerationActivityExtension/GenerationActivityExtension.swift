...
private func symbol(_ state: SakrylleGenerationActivityAttributes.ContentState, stale: Bool) -> String {
...
private func activityIsStale(_ context: ActivityViewContext<SakrylleGenerationActivityAttributes>) -> Bool {
