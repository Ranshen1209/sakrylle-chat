...
import 'package:sakrylle_chat/features/settings/pages/settings_page.dart';
...
void main() {
  ...
  testWidgets(
    'mobile settings lists Tool Descriptions below Logs without a sponsorship entry',
    (tester) async {
      ...
      expect(labels, isNot(contains('Sponsor')));
      expect(
        labels.where((label) => label == 'Tool Descriptions'),
        hasLength(1),
      );
      expect(
        labels.indexOf('Tool Descriptions'),
